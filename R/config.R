        ...
        observeEvent(input$config_btn, {
            ...
            showModal(modalDialog(
                ...
                selectInput(
                    ...
                    choices = c(
                        'llama-3.1-70b-instruct', 'llama-3.1-8b-instruct', 'llama-3.1-nemotron-nano-8B-v1', 'llama-3.3-70b-instruct', 'mistral-7b-instruct',
                        'mistral-small-3.1', 'codestral-22b', 'gemma-3-27b-it', 'gpt-oss-20b', 'gpt-oss-120b', 'granite-3.3-8b-instruct', 'sfr-embedding-mistral', 'nomic-embed-text-v1.5', 'flux.1-dev', 'flux.1-schnell',
